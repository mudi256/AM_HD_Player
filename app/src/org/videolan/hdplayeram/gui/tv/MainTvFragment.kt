...
import org.videolan.hdplayeram.ExternalMonitor
import org.videolan.hdplayeram.R
import org.videolan.hdplayeram.RecommendationsService
import org.videolan.hdplayeram.database.models.BrowserFav
import org.videolan.hdplayeram.gui.preferences.PreferencesFragment
import org.videolan.hdplayeram.gui.tv.MainTvActivity.ACTIVITY_RESULT_PREFERENCES
import org.videolan.hdplayeram.gui.tv.MainTvActivity.BROWSER_TYPE
import org.videolan.hdplayeram.gui.tv.TvUtil.diffCallback
import org.videolan.hdplayeram.gui.tv.audioplayer.AudioPlayerActivity
import org.videolan.hdplayeram.gui.tv.browser.VerticalGridActivity
import org.videolan.hdplayeram.repository.BrowserFavRepository
import org.videolan.hdplayeram.repository.DirectoryRepository
import org.videolan.hdplayeram.repository.createDirectory
import org.videolan.hdplayeram.util.*
import org.videolan.hdplayeram.viewmodels.HistoryModel
    ...
    override fun onItemClicked(itemViewHolder: Presenter.ViewHolder?, item: Any?, rowViewHolder: RowPresenter.ViewHolder?, row: Row?) {
        ...
        when(row?.id) {
            ...
            HEADER_MISC -> {
                ...
                when (id) {
                    ID_SETTINGS -> activity.startActivityForResult(Intent(activity, org.videolan.hdplayeram.gui.tv.preferences.PreferencesActivity::class.java), ACTIVITY_RESULT_PREFERENCES)
                    ID_ABOUT_TV -> activity.startActivity(Intent(activity, org.videolan.hdplayeram.gui.tv.AboutActivity::class.java))
                    ID_LICENCE -> startActivity(Intent(activity, org.videolan.hdplayeram.gui.tv.LicenceActivity::class.java))
                }
            }
