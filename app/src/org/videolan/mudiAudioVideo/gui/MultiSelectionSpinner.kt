...
class MultiSelectionSpinner : AppCompatSpinner, OnMultiChoiceClickListener, DialogInterface.OnDismissListener{
    ...
    private var listener: org.videolan.mudiAudioVideo.gui.OnItemSelectListener? = null
    ...
    fun setOnItemsSelectListener(l: org.videolan.mudiAudioVideo.gui.OnItemSelectListener) {
        listener = l
    }
}
