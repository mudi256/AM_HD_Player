...
import org.videolan.mudiAudioVideo.RecommendationsService
import org.videolan.mudiAudioVideo.database.models.BrowserFav
import org.videolan.mudiAudioVideo.gui.preferences.PreferencesFragment
import org.videolan.mudiAudioVideo.gui.tv.MainTvActivity.ACTIVITY_RESULT_PREFERENCES
import org.videolan.mudiAudioVideo.gui.tv.MainTvActivity.BROWSER_TYPE
import org.videolan.mudiAudioVideo.gui.tv.TvUtil.diffCallback
import org.videolan.mudiAudioVideo.gui.tv.audioplayer.AudioPlayerActivity
import org.videolan.mudiAudioVideo.gui.tv.browser.VerticalGridActivity
import org.videolan.mudiAudioVideo.repository.BrowserFavRepository
import org.videolan.mudiAudioVideo.repository.DirectoryRepository
import org.videolan.mudiAudioVideo.repository.createDirectory
import org.videolan.mudiAudioVideo.util.*
import org.videolan.mudiAudioVideo.viewmodels.HistoryModel
    ...
    override fun onItemClicked(itemViewHolder: Presenter.ViewHolder?, item: Any?, rowViewHolder: RowPresenter.ViewHolder?, row: Row?) {
        ...
        when(row?.id) {
            ...
            HEADER_MISC -> {
                ...
                when (id) {
                    ID_SETTINGS -> activity.startActivityForResult(Intent(activity, org.videolan.mudiAudioVideo.gui.tv.preferences.PreferencesActivity::class.java), ACTIVITY_RESULT_PREFERENCES)
                    ID_ABOUT_TV -> activity.startActivity(Intent(activity, org.videolan.mudiAudioVideo.gui.tv.AboutActivity::class.java))
                    ID_LICENCE -> startActivity(Intent(activity, org.videolan.mudiAudioVideo.gui.tv.LicenceActivity::class.java))
                }
            }
