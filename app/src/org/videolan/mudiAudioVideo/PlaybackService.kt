...
import org.videolan.mudiAudioVideo.gui.helpers.BitmapUtil
import org.videolan.mudiAudioVideo.gui.helpers.NotificationHelper
import org.videolan.mudiAudioVideo.gui.video.PopupManager
...
import org.videolan.mudiAudioVideo.widget.VLCAppWidgetProvider
import org.videolan.mudiAudioVideo.widget.VLCAppWidgetProviderBlack
import org.videolan.mudiAudioVideo.widget.VLCAppWidgetProviderWhite
...
class PlaybackService : MediaBrowserServiceCompat(), CoroutineScope, LifecycleOwner {
    ...
    private fun broadcastMetadata() {
        ...
        launch(Dispatchers.Default) { sendBroadcast(Intent("com.android.music.metachanged")
                    ...
                    .putExtra("package", "org.videolan.mudiAudioVideo"))
        }
    }
