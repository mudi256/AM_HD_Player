...
package org.videolan.mudiAudioVideo.database
...
import org.videolan.mudiAudioVideo.database.helpers.*
...
import org.videolan.mudiAudioVideo.database.models.Slave
import org.videolan.mudiAudioVideo.util.Settings
import org.videolan.mudiAudioVideo.util.TYPE_NETWORK_FAV
import org.videolan.mudiAudioVideo.util.TestUtil
import org.videolan.mudiAudioVideo.util.getValue
...
class MigrationTest {
    ...
    @Test fun migrateFrom26() {
        // Slave
        val slaveMedia1Path = "/storage/emulated/0/Android/data/org.videolan.mudiAudioVideo.debug/files/subs/file1.mkv"
        val slaveMedia1UriFa = "file:///storage/emulated/0/Android/data/org.videolan.mudiAudioVideo.debug/files/subs/file1.fa.srt"
        // External Sub
        val exSubMedia1Name = "file1.mkv"
        val exSubMedisubsFolder = "/storage/emulated/0/Android/data/org.videolan.mudiAudioVideo.debug/files/subs/"
        val exSubfile1Sub1 = "${exSubMedisubsFolder}file1.eng.srt"
        // Favs
        val favUri = Uri.parse("/storage/emulated/0/Android/data/org.videolan.mudiAudioVideo.debug/files/subs/file1.mkv")
        val favTitle = "test1"
