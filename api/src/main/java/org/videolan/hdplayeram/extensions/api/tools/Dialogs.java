 ...
 * ***************************************************************************
 */
package org.videolan.hdplayeram.extensions.api.tools;
...
import org.videolan.hdplayeram.plugin.api.R;
    ...
    public static AlertDialog showInstallVlc(@NonNull final Activity activity) {
        return showAlertDialog(activity, R.string.vlc_error_title, R.string.vlc_error_message,
                new DialogInterface.OnCancelListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=org.videolan.hdplayeram")));
                        dialog.dismiss();
                        activity.finish();
                    }
                }, null);
